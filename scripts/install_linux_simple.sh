# Description: Script d'installation des dépendances pour Linux (simple)
# Version: 1.0
#!/bin/bash
...
# Créez un répertoire apps/myApps
mkdir apps/myApps/app -p

# Déplacer le projet dans le répertoire apps/myApps/app
mv ../* apps/myApps/app
